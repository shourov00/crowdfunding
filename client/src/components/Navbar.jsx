        ...
        <div className={"flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6"}>
            <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]">
                <input type="text" placeholder={"Search for campaigns"}
                       ...
                       "text-white bg-transparent outline-none mr-4"}/>
            ...
            <div className={"sm:hidden flex justify-between items-center relative"}>
                ...
                bg-[#1c1c24] z-10 shadow-secondary py-4 ${toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} 
                    ...
                    <ul className="mb-4">
                        {navlinks.map(link => (
                            <li key={link.name}
                                ...
                                ${isActive === link.name ? 'grayscale-0' : 'grayscale'}`} src={link.imgUrl} alt={link.name} />
